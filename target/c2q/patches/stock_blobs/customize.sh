...
ADD_TO_WORK_DIR "$TARGET_FIRMWARE" "system" "system/priv-app/GameDriver-SM8350/GameDriver-SM8250.apk" 0 0 644 "u:object_r:system_file:s0"
LOG_STEP_OUT
...
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/bin/insthk"
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/bin/remotedisplay"
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/lib/libhwui.so"
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/lib64/libhwui.so"
LOG_STEP_OUT
...
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/lib/libremotedisplay.so" 0 0 644 "u:object_r:system_lib_file:s0"
ADD_TO_WORK_DIR "a52sxqxx" "system" "system/lib64/libremotedisplay.so" 0 0 644 "u:object_r:system_lib_file:s0"
...
LOG_STEP_IN "- Adding RIL SHIT"
ADD_TO_WORK_DIR "$SOURCE_FIRMWARE" "vendor" "lib64/libSemTelephonyProps.so" 0 0 644 "u:object_r:vendor_file:s0"
ADD_TO_WORK_DIR "$SOURCE_FIRMWARE" "vendor" "lib64/libril_sem.so" 0 0 644 "u:object_r:vendor_file:s0"
ADD_TO_WORK_DIR "$SOURCE_FIRMWARE" "vendor" "lib64/libsec-ril.so" 0 0 644 "u:object_r:vendor_file:s0"
LOG_STEP_IN "-PRAYING"
LOG_STEP_OUT
